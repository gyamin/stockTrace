...
interface ItemDao {
    ...
    @SqlQuery("select code, trading_name, market_type, sector33_code, sector33_name, sector17_code, sector17_name, scale_code, scale_name, created_at, updated_at from items where code = :code")
    @RegisterKotlinMapper(ItemBean::class)
